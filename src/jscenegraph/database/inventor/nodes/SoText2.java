...
////////////////////////////////////////////////////////////////////////
{
    ...
    for (int line = 0; line < string.getNum(); line++) {
        ...
        for (chr = 0; chr < len; chr++) {
            myFont.getCharBbox(str.charAt(/*2**/chr), charBbox);
            ...
            if (!charBbox.isEmpty()) {
                ...
                charPosition.operator_add_equal(myFont.getCharOffset(str.charAt(/*2**/chr)));
            }
        }
            ...
            if (pp != null) {
                ...
                for (chr = 0; chr < len; chr++) {
                    charPosition.operator_add_equal( 
                        myFont.getCharOffset(str.charAt(/* 2**/chr)));

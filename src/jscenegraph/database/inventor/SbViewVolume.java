...
public SbViewVolume(SbViewVolume other) {
	 ...
	 * The second is suitable for use as a projection matrix in OpenGL. 
	 * 
	 * @param affine
	 * @param proj
	 */
...
////////////////////////////////////////////////////////////////////////
{
	...
	/**
	 * Like the method above, but returns the affine and projection 
...
public void projectPointToLine(final SbVec2f pt,
                                 SbVec3f line0, SbVec3f line1)
//
////////////////////////////////////////////////////////////////////////
{
...
////////////////////////////////////////////////////////////////////////
{
	 ...
	 * which goes (nonlinearly) from 0 at the near clipping plane 
...
public SbVec3f
getPlanePoint(float distFromEye, final SbVec2f normPoint)
//
////////////////////////////////////////////////////////////////////////
{
...
public float
getWorldToScreenScale(final SbVec3f worldCenter,
                                    float normRadius)
//
////////////////////////////////////////////////////////////////////////
{
    ...
    return answerDist;
	 ...
	 //
	   ...
	   //
	   {
	       ...
	       for (int i = 0; i < 8; i++)
	           fBox.extendBy(new SbVec2f(screenPoint[i].operator_square_bracket(0), screenPoint[i].operator_square_bracket(1)));
...
////////////////////////////////////////////////////////////////////////
{
    ...
    vv.llfO.copyFrom((lrfO.operator_minus(llfO)).operator_mul(left).operator_add((ulfO.operator_minus(llfO)).operator_mul(bottom)).operator_add(llfO));
    vv.lrfO.copyFrom((lrfO.operator_minus(llfO)).operator_mul(right).operator_add((ulfO.operator_minus(llfO)).operator_mul(bottom)).operator_add(llfO));
    vv.ulfO.copyFrom((lrfO.operator_minus(llfO)).operator_mul(left).operator_add((ulfO.operator_minus(llfO)).operator_mul(top)).operator_add(llfO));
    ...
    return vv;
	    ...
	    * In this coordinate system, the z value of the near plane 
...
public SbViewVolume
zNarrow(float nearVal, float farVal)
//
////////////////////////////////////////////////////////////////////////
{
    final SbPlane             plane = new SbPlane();
    ...
    return narrowed;
	   ...
	   public void
	    ...
	    public void
	    perspective(float fovy, float aspect,
	                              float nearVal, float farVal)
	    //
	    ////////////////////////////////////////////////////////////////////////
	    {
	    ...
	    public void
	    translateCamera(final SbVec3f v)
	    //
	    ////////////////////////////////////////////////////////////////////////
	    {
	    ...
	    public void
	    rotateCamera(final SbRotation r)
	    //
	    ////////////////////////////////////////////////////////////////////////
	    {
...
////////////////////////////////////////////////////////////////////////
{
    ...
    public ProjectionType      getProjectionType() { return type; }

    //! Returns projection information.
    public SbVec3f      getProjectionPoint()  { return projPoint; }

    //! Returns projection information.
    public SbVec3f      getProjectionDirection()    { return projDir; }
    ...
    //! Returns bounds of viewing frustum.
    public float               getHeight()      { return (ulfO.operator_minus(llfO)).length(); }
    //! Returns bounds of viewing frustum.
    public float               getDepth()       { return nearToFar; }
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (type == ProjectionType.PERSPECTIVE) {
        ...
        final SbPlane farPlane = new SbPlane(ulfO.operator_add(farOffset), llfO.operator_add(farOffset), lrfO.operator_add(farOffset));
...
public boolean
intersect(final SbVec3f p0, final SbVec3f p1,
                        final SbVec3f closestPoint)
//
////////////////////////////////////////////////////////////////////////
{
    ...
    centerPt.copyFrom( llfO.operator_add(projPoint.operator_add(((ulfO.operator_minus(llfO)).operator_add((lrfO.operator_minus(llfO)))).operator_mul(0.5f))));
    if (type == ProjectionType.ORTHOGRAPHIC)
...
public boolean
outsideTest(final SbPlane p,
                          final SbVec3f min, final SbVec3f max)
//
////////////////////////////////////////////////////////////////////////
{

...
public class SoGLDisplayList implements Destroyable {
   ...
   public enum Type {
    ...
    if (type == Type.TEXTURE_OBJECT) {
        gl2.glGenTextures(1, startIndex, 0); //glGenTextures(1, &startIndex);
//#ifdef DEBUG
        if (num != 1)
...
//#endif
        ...
        gl2.glGenBuffers(1, startIndex, 0);//glGenBuffersARB(1, &startIndex);
    } else {
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (type == Type.TEXTURE_OBJECT) {
        gl2.glDeleteTextures(1, startIndex, 0); //glDeleteTextures(1, &startIndex);
    } else if (type == Type.VERTEX_BUFFER_OBJECT) {
        gl2.glDeleteBuffers(1, startIndex, 0);//glDeleteBuffersARB(1, &startIndex);
    } else {
